...
public class MultiMCLauncher
{
	...
	public static void launch(String[] args)
	{
		...
		String lwjgl = args[4];
		String cwd = System.getenv("APPDATA").concat("\\.grueziforge\\minecraft\\");//System.getProperty("user.dir");
		...
		try
		{
			File binDir = new File(System.getenv("APPDATA").concat("\\.grueziforge\\minecraft\\bin"));
			File lwjglDir;
